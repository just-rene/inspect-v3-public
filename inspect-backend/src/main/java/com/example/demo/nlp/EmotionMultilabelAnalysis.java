...
@Component
public class EmotionMultilabelAnalysis {
    ...
    public String getEmotionAnalysis(String input){
        ...
        try {
            ...
            response = huggingFaceRequest.makeRequest("{" + input +"}", HuggingFaceRequest.HuggingFaceModelUrl.EMOTION_MULTILABEL);
